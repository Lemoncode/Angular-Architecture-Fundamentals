...
```bash
$ ng g c games/game-edit --module=games --spec false
```
      ...
      <fieldset *ngIf="game">
          <div class="form-group"
              ...
              <div class="col-md-8">
                  <input class="form-control"
                         ...
                         required
                         minlength="3"
                         [(ngModel)]=game.gameName
                         name="gameName"
                         #gameNameVar="ngModel" />
                  <span class="help-block" *ngIf="(gameNameVar.touched ||
                                                   gameNameVar.dirty || game.id !== 0) &&
                                                   gameNameVar.errors">
          ...
          <div class="form-group"
              ...
              <div class="col-md-8">
                  <input class="form-control"
                         ...
                         required
                         [(ngModel)]=game.gameCode
                         name="gameCode"
                         #gameCodeVar="ngModel" />
                  <span class="help-block" *ngIf="(gameCodeVar.touched ||
                                                   gameCodeVar.dirty || game.id !== 0) &&
                                                   gameCodeVar.errors">
          ...
          <div class="form-group">
              <div class="col-md-4 col-md-offset-2">
                  ...
                  <span>
                      <a class="btn btn-default" style="width:80px" (click)="deletegame()">
                          Delete
                      </a>
                  </span>
              </div>
...
```
```typescript game-edit.component.ts
...
```bash
$ ng g c games/game-details --module=games --spec false
```

```html game-details.component.html
...
```typescript game-details.component.ts
