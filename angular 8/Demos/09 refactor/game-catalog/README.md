...
```bash
$ ng g c games/game-edit --module=games --skipTests
```
...
```bash
$ ng g c games/game-details --module=games --skipTests
```
...
__src\app\games\game-details\game-details.component.ts__
...
__src\app\home\menu.component.ts__
